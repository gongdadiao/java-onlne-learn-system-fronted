...
export function getAdminRecordList (id,parameter) {
  return axios({
    url: api.AdminRecordList+id,
    method: 'get',
    params: parameter
  })
}

export function getAdminRecordDetail (parameter) {
  return axios({
    url: api.AdminGetOneExamRecord,
    method: 'get',
    params: parameter
  })
}
...
export function submitMarked (id,parameter) {
  return axios({
    url: api.SubmitMarked+id,
    method: 'post',
    data: parameter
  })
}

export function getAdminQuestionList(parameter){
  return axios({
    url: api.AdminQuestionList,
    method: 'get',
    params: parameter
  })
}
...
export function addOneQuestion(paramter) {
  return axios({
    url: api.QuestionAdd,
    method: 'post',
    data: paramter,
...
export function addOneExam(paramter) {
  return axios({
    url: api.ExamCreate,
    method: 'post',
    data: paramter,
