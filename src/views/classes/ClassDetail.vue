<template>
    <div>
      <template>
        <a-tabs>
          <a-tab-pane tab="课件" key="1">
            <template style="margin: auto;width: 80%;">
              <div>
      ...
      <create-theme @getClassInfo="getThisCourseInfo" v-bind:class-id="this.$route.params.id" ref="createTheme"></create-theme>
      <step-by-step-chapter-modal @getClassInfo="getThisCourseInfo" v-bind:theme-id="chooseThemeId" ref="createChapter"></step-by-step-chapter-modal>
    </div>
</template>
