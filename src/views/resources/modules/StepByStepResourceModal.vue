        ...
        <div v-show="currentStep === 1">
          ...
          >
            <a-select v-model="resSelection.type" defaultValue="video" style="width: 120px" @change="selectResType">
              ...
              <a-select-option value="word文档">word文档</a-select-option>
              <a-select-option value="源码">源码</a-select-option>
...
<script>
  ...
  import { getAdminQuestionList,getQuestionList } from '../../../api/exam'
    ...
    methods: {
      ...
      handleNext (step) {
        ...
        validateFields((errors, values) => { // values就是表单中校验的值，后面提交到后端接口时主要就是用这个values
          if(this.resSelection.avartar==null || this.resSelection.avartar==''){
            this.$message.error('请设置资源小图')
            this.confirmLoading = false
            return
          }
          if(this.resSelection.url==null || this.resSelection.url==''){
